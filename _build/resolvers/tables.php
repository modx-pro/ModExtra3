...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('ModExtra\Model', MODX_CORE_PATH . 'components/modextra/src/', null, 'ModExtra\\');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/modextra/schema/modextra.mysql.schema.xml';
